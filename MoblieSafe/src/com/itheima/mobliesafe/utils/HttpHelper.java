...
public class HttpHelper {
	...
	/** post请求，获取返回字符串内容 
	 * @throws IOException */
	public static HttpResult post(String url, byte[] bytes) throws IOException {
	...
	/** 下载 
	 * @throws IOException */
	public static HttpResult download(String url) throws IOException {
		HttpGet httpGet = new HttpGet(url);
		return execute(url, httpGet);
	}
	...
	/** 执行网络访问 
	 * @throws IOException */
	private static HttpResult execute(String url, HttpRequestBase requestBase) throws IOException {
