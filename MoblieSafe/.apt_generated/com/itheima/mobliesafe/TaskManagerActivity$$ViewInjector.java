...
public class TaskManagerActivity$$ViewInjector {
  public static void inject(Finder finder, final com.itheima.mobliesafe.TaskManagerActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492909, "field 'tv_taskmanager_freeandtotalram'");
    target.tv_taskmanager_freeandtotalram = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131492910, "field 'lv_taskmanager_processes'");
    ...
    view = finder.findRequiredView(source, 2131492908, "field 'tv_taskmanager_processes'");
