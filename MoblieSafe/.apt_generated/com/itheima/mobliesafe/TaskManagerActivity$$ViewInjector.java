...
public class TaskManagerActivity$$ViewInjector {
  public static void inject(Finder finder, final com.itheima.mobliesafe.TaskManagerActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492903, "field 'lv_taskmanager_processes'");
    ...
    view = finder.findRequiredView(source, 2131492901, "field 'tv_taskmanager_processes'");
    target.tv_taskmanager_processes = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131492902, "field 'tv_taskmanager_freeandtotalram'");
