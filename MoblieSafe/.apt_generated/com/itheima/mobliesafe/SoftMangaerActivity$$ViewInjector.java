...
public class SoftMangaerActivity$$ViewInjector {
  public static void inject(Finder finder, final com.itheima.mobliesafe.SoftMangaerActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492890, "field 'tv_softmanager_rom'");
    target.tv_softmanager_rom = (android.widget.TextView) view;
    view = finder.findRequiredView(source, 2131492891, "field 'tv_softmanager_sd'");
    ...
    view = finder.findRequiredView(source, 2131492892, "field 'lv_softmanager_application'");
    target.lv_softmanager_application = (android.widget.ListView) view;
    view = finder.findRequiredView(source, 2131492893, "field 'tv_softmanager_userorsystem'");
